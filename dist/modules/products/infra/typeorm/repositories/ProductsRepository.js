...
var ProductsRepository = /** @class */ (function () {
    ...
    ProductsRepository.prototype.findAllById = function (products) {
        return __awaiter(this, void 0, void 0, function () {
            var productsIds, productSearch;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        productsIds = products.map(function (p) { return p.id; });
                        return [4 /*yield*/, this.ormRepository.find({
                                where: {
                                    id: typeorm_1.In(productsIds),
                                },
                            })];
                    case 1:
                        productSearch = _a.sent();
                        return [2 /*return*/, productSearch];
                }
            });
        });
    };
    ProductsRepository.prototype.updateQuantity = function (products) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // TODO
                return [2 /*return*/, this.ormRepository.save(products)];
            });
        });
    };
